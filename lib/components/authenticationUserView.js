...
var AuthenticationUserView = (function (_React$Component) {
    ...
    function AuthenticationUserView(props, context) {
        ...
        _get(Object.getPrototypeOf(AuthenticationUserView.prototype), 'constructor', this).call(this, props, context);
        this.state = {
            visible: false,
            imageurl: "",
            user: "",
    ...
    _createClass(AuthenticationUserView, [{
        ...
        key: '_handleEmailInput',
        value: function _handleEmailInput() {
            this.setState({
